...
public interface Profile {
     ...
     */
    @WebMethod
    String addProfile(int id, String name, String email, String phone, String username, String password, boolean isDriver);
     ...
     */
    @WebMethod
    void updateProfile(String access_token, int id, String name, String phone, String profilePic, String status );
}